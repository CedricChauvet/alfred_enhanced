...
class ReActLightModule(CoTModule):
    ...
    def __init__(self, args, vocab):
        ...
        self.use_react = True  # DISABLED FOR TEST
        self.use_cot = True  # Enable CoT
    ...
    def _create_thought_vocab(self):
        """
        Crée un vocabulaire simplifié de thoughts
        
        Ces thoughts seront générés automatiquement pendant training
        et utilisés pour le debugging pendant inference
        """
        return {
            # Navigation
            0: "need_to_navigate",
    ...
    def forward(self, feat, max_decode=300, env_feedback=None):
        ...
        if self.use_react and env_feedback is not None:
